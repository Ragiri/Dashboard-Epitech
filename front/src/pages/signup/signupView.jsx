...
class SignupView extends React.Component {
  ...
  googleResponse = (response) => {
    ...
    fetch(`${config.apiRootUrl}/signup`, {
      method: "POST",
  ...
  checkExistMail = (mail, nameval, password) => {
    const body = {
      pass: password,
      name: nameval,
      email: mail,
    ...
    return (
      ...
      >
        ...
        <Grid container align="center" alignContent="center" alignItems="center" justify="center">
            ...
            <Typography className={classes.title}>{"Email Sign up"}</Typography>
            <Grid item xs={10} sm={7} style={{ marginTop: 35 }} align="center">
            ...
            <Grid item xs={10} sm={7} style={{ marginTop: 35 }} align="center">
            <TextField required id="outlined-basic" label="Name" variant="outlined" className={classes.inputbtn} value={this.state.nameValue} onChange={this.handleChangeName}/>
            </Grid>
            <Grid item xs={10} sm={7} style={{ marginTop: 35 }} align="center">
            ...
            <Grid item xs={10} sm={7} style={{ marginTop: 35 }} align="center">
            <Button className={classes.btn} onClick={() => this.checkExistMail(emailValue, nameValue, passValue)}>
            {"Send"}
            </Button>
            </Grid>
            </Grid>
